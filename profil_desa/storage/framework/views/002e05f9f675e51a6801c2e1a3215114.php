<nav x-data="{ scrolled: false }" 
  ...
  <div class="navbar-container">
    <!-- Logo -->
    <a href="#" class="logo">
      <img :src="scrolled ? '<?php echo e(asset('images/logo-giveat-hitam.png')); ?>' : '<?php echo e(asset('images/logowhite.png')); ?>'" 
           alt="GivEats" 
...
<?php /**PATH D:\code\laragon\www\profil_desa\resources\views\layouts\navigation\landing.blade.php ENDPATH**/ ?>