        ...
        <div class="flex items-center h-16 w-full">
            ...
            <div class="shrink-0 flex items-center" style="min-width:180px;">
                <a href="<?php echo e(route('dashboard')); ?>">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="GivEat" class="logo-img" style="max-width: 150px; height: auto;">
                </a>
            </div>
            <!-- Menu utama center -->
            <style>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('admin.dashboard'),'active' => request()->routeIs('admin.dashboard'),'class' => 'nav-link']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.dashboard')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('admin.dashboard')),'class' => 'nav-link']); ?>
                        <?php echo e(__('Home')); ?>
                        ...
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="profile flex items-center space-x-2">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>">
                                    <img src="<?php echo e(Auth::user()->image ? Storage::url(Auth::user()->image) : asset('profile/default.png')); ?>"
                                        alt="Profile"
...
</nav><?php /**PATH D:\code\laragon\www\profil_desa\resources\views/layouts/navigation/admin.blade.php ENDPATH**/ ?>