...
<section class="relative w-full py-20 overflow-hidden">
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/bgtes.jpg')); ?>" alt="BG" class="w-full h-full object-cover" />
    </div>
...
<div class="max-w-3xl mx-auto -mt-10 mb-12 px-4 z-10 relative">
    <form method="GET" action="">
        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari berita atau kegiatan..."
...
<div class="w-[85%] mx-auto bg-white shadow-2xl rounded-2xl py-10 px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-xl overflow-hidden shadow-lg"> 
            <img src="<?php echo e(asset('storage/' . $konten->cover)); ?>" alt="Cover"
            ...
            <div class="p-5 flex flex-col justify-between h-[290px]">
                <div>
                    <h3 class="text-lg font-bold text-green-800 mb-2 break-words line-clamp-2 uppercase">
                        <?php echo e(\Illuminate\Support\Str::limit($konten->judul, 100)); ?>

                    </h3>
                    <p class="text-sm text-gray-600 line-clamp-3 mb-3">
                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($konten->deskripsi), 120)); ?>
                ...
                <div class="flex items-center justify-between mt-auto pt-2 border-t border-gray-200">
                    <div class="flex flex-wrap gap-3 text-sm text-gray-500 mt-2 items-center">
                        <div class="flex items-center gap-1">
                            ...
                            <span><?php echo e($konten->created_at->format('d M Y')); ?></span>
                        </div>
                        <div class="flex items-center gap-1">
                            <i class="bx bx-user text-base"></i>
                            <span><?php echo e($konten->user->name ?? 'User'); ?></span>
                        </div>
                        <div class="flex items-center gap-1">
                            <i class="bx bx-show text-base"></i>
                            <span><?php echo e($konten->dibaca); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('user.berita.show', $konten->id)); ?>"
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Jopu\Downloads\profil_desa\profil_desa\resources\views/berita.blade.php ENDPATH**/ ?>