...
<body class="antialiased">
    <div class="min-h-screen flex flex-col">
        ...
        <?php if(isset($header)): ?>
            <header class="bg-white shadow-md" style="background-image: url('<?php echo e(asset('images/bgtes.jpg')); ?>'); background-size: cover; background-position: center;">
...
</html><?php /**PATH C:\Users\Jopu\Downloads\profil_desa\profil_desa\resources\views/layouts/app.blade.php ENDPATH**/ ?>